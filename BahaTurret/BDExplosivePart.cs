	...
	//	bool hasFired = false;
		...
		public void Detonate()
		{
			if(!hasDetonated)
			{
				...
				ExplosionFX.CreateExplosion(position, blastRadius, blastPower, blastHeat, vessel, FlightGlobals.getUpAxis(), "BDArmory/Models/explosion/explosionLarge", "BDArmory/Sounds/explode1", true);
			}
		}
	}
}
